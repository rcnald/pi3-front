...
// import { Edit, Trash2 } from 'lucide-react'; // Exemplo de ícones
        ...
        <form className="space-y-5">
          <div>
            ...
            <select className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 bg-white">
              ...
              <option>Caminhar</option>
              <option>Meditar</option>
            </select>
          </div>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {registros.map((reg) => (
                <tr key={reg.id}>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{reg.obj}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{reg.qtd}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{reg.un}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{reg.data}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-3">
                    <button className="text-cyan-600 hover:text-cyan-800">✏️</button>
